    ...
    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0"
            ...
            <tr style="margin-bottom:0;padding-bottom:0%">
                <td valign="top" class="textContent">
                    <div mc:edit="body"
                        style="text-align:left;font-family:'JTEnergyVariable';font-size:14px;margin-top:-14px;background-color:transparent;padding:13px 12px 16px 15px">
    ...
    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0"
            ...
            <tr style="margin-bottom:0;padding-bottom:0%">
                <td valign="top" class="textContent">
                    <div mc:edit="body"
                        style="text-align:left;font-family:'JTEnergyVariable';font-size:14px;margin-top:0px;background-color:transparent;margin-left: 12px;">
                        <table>
                            <tbody>
                                <tr style="border:none">
                                    <th style="padding-right:20px;">Product Details:</th>
                                    <td style="padding-left:20px;border-left: 1px solid #7d7d7d;">Dune Buggy Safari Evening Drive</td>
                                </tr>        
                                <tr style="border:none">
                                    <th style="padding-right:20px;">Date:</th>
                                    <td style="padding-left:20px;border-left: 1px solid #7d7d7d;">Wednesday 04 March 2020</td>
                                </tr>      
                                <tr style="border:none">
                                    <th style="padding-right:20px;">Type:</th>
                                    <td style="padding-left:20px;border-left: 1px solid #7d7d7d;">Private</td>
                                </tr>         
                                <tr style="border:none">
                                    <th style="padding-right:20px;">Qty:</th>
                                    <td style="padding-left:20px;border-left: 1px solid #7d7d7d;">2</td>
                                </tr>  
                                <tr style="border:none">
                                    <th style="padding-right:20px;">Price(AED):</th>
                                    <td style="padding-left:20px;border-left: 1px solid #7d7d7d;">200</td>
                                </tr> 
                                <tr style="border:none">
                                    <th style="padding-right:20px;">Total(AED):</th>
                                    <td style="padding-left:20px;border-left: 1px solid #7d7d7d;">1000</td>
                                </tr>
            </tr>     
                            </tbody>
                        </table>
