                                        ...
                                        <div class="col-6">
                                            <div class="cart-icons">
                                                <a href="#" class="delete-icon" data-toggle="modal" data-target="#cancellation-confirm">
                                                    <img src="assets/images/remove.png" alt="remove-icon"/>Delete</a>
                                ...
                                <li>
                                    ...
                                    <div class="row col-12">
                                        <div class="col-6">
                                            <div class="cart-icons">
                                                <a href="#" class="delete-icon" data-toggle="modal" data-target="#cancellation-confirm">
                                                    <img src="assets/images/remove.png" alt="remove-icon" /> Delete
                                                </a>
                                                <a href="#" class="edit-icon">
                                                    <img src="assets/images/edit.png" alt="edit" /> Edit
                                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12 cart-btn">
                            <a href="<?php echo base_url('things-to-do/checkout'); ?>"
                                class="checkout-btn more-btn hvr-radial-out">Checkout</a>
                            <a href="<?php echo base_url('things-to-do/search'); ?>"
                                class="more-activities more-btn hvr-radial-out btn-light">Explore more activities</a>
                        </div>
                    </div>
...
<div class="custom-slider most-popular-things">
    <h3>Recommended activities for you near Dubai</h3>
