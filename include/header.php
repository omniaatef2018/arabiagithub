                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul class="sub-menu huge-menu">
                                                <li>
                                                <button class="login-profile button" data-toggle="modal" data-target="#login-modal"> 
                                                    <img src="assets/images/user.png" alt="user icon" class="nav-icon"/>LogIn
                                                </button>
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            <a href="#" data-toggle="modal" data-target="#signup-modal" class="btn signup-btn more-btn hvr-radial-out btn-light">
                                                SignUp
                                            </a>
                                        </li>   
                                    </ul>
